...
lyr_Bluebird_2.set('fieldImages', {'fid': 'TextEdit', 'id': 'Hidden', 'state': 'Hidden', 'state_abb': 'Hidden', 'state_id': 'Hidden', 'county': 'Hidden', 'county_id': 'Hidden', 'operator': 'TextEdit', 'ref': 'TextEdit', 'name': 'TextEdit', 'sqft': 'Hidden', 'lon': 'Hidden', 'lat': 'Hidden', 'type': 'Hidden', 'Fiber_Carriers': 'TextEdit', 'Char_Length': 'Hidden', 'Shortlist': 'Hidden', 'Num_Carriers': 'Range', 'Max_Power_Capacity.MW': 'TextEdit', 'Whitespace.SQFT': 'Range', });
...
lyr_Bluebird_2.set('fieldLabels', {'fid': 'header label - visible with data', 'operator': 'header label - visible with data', 'ref': 'header label - visible with data', 'name': 'header label - visible with data', 'Fiber_Carriers': 'header label - visible with data', 'Num_Carriers': 'header label - visible with data', 'Max_Power_Capacity.MW': 'header label - visible with data', 'Whitespace.SQFT': 'header label - visible with data', });
...
lyr_AllDataCenters_12.set('fieldLabels', {'operator': 'header label - visible with data', 'ref': 'header label - visible with data', 'name': 'header label - visible with data', 'Fiber_Carriers': 'header label - visible with data', 'Num_Carriers': 'header label - visible with data', 'Max_Power_Capacity.MW': 'header label - visible with data', 'Whitespace.SQFT': 'header label - visible with data', });
